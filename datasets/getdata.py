...
def generate_class_info(dataset_name):
    ...
    if dataset_name == 'mvtec':
        ...
        obj_list = ['candle', 'capsules', 'cashew', 'chewinggum', 'fryum', 'macaroni1',
                    'macaroni2', 'pcb1', 'pcb2', 'pcb3', 'pcb4', 'pipe_fryum']
    elif dataset_name == 'mpdd':
        obj_list = ['bracket_black', 'bracket_brown', 'bracket_white', 'connector', 'metal_plate', 'tubes']
    elif dataset_name == 'btad':
        obj_list = ['01', '02', '03']
    elif dataset_name == 'dagm' or dataset_name == 'dagm_':
        obj_list = ['Class1', 'Class2', 'Class3', 'Class4', 'Class5',
                    'Class6', 'Class7', 'Class8', 'Class9', 'Class10']
    elif dataset_name == 'dagm__':
        obj_list = ['Fabric1', 'Fabric2', 'Fabric3', 'Fabric4',
                    'Fabric5', 'Fabric7', 'Fabric8']
    elif 'sdd' in dataset_name:
        obj_list = ['Metal']
    elif 'dtd' in dataset_name:
        obj_list = ['Woven_001', 'Woven_127', 'Woven_104', 'Stratified_154', 'Blotchy_099', 'Woven_068',
                    'Woven_125', 'Marbled_078', 'Perforated_037', 'Mesh_114', 'Fibrous_183', 'Matted_069']

    # medical datasets
    elif dataset_name in ('clinicdb', 'colondb', 'kvasir', 'endo'):
        obj_list = ['colon']
